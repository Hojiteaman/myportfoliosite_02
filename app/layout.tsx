...
export default function RootLayout({
  ...
  return (
    <html lang="ja">
      <body className="min-h-screen bg-state-50 text-gray-900">
        <header className="sticky top-0 z-50 bg-white shadow-sm">
          <div className="mx-auto flex max-w-6xl items-center bg-state-50 justify-between px-4 py-4">
        ...
        <main className="mx-auto max-w-6xl bg-state-50 px-4 py-10">
          {children}
        </main>
