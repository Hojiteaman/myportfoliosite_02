...
export default function WorkDetailPage({
  ...
  /></div>
      ...
      <p className="text-gray-700">
        ...
        役割分担のもと、私は服の3Dモデルを担当しました。<br/>
        プロジェクトメンバーの中では私は比較的製作への負荷が小さかったため、技術以外の要素でも貢献しようと考えました。そこでプロジェクト主導者に連絡をとり、週１で開発状況やフィードバックを共有できる機会を設け、プロジェクトを円滑に進めるように努力しました。<br />
        ...
        私はパリの宿泊先探しを担当し、治安が良く学生でも利用しやすい価格帯の宿を探しました。また、荷物預かりが無料と記載されているにもかかわらず現地で有料請求されるケースがあることを想定し、事前にメールでオプションの確認を実施しました。実際に同様の事例に遭遇しましたが、事前のメールが証拠となり問題なく対応することができました。
      </p>
      <div></div>
      <div className="relative h-64 w-full sm:h-80">
      <Image
