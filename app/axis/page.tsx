  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-16">
      ...
      <section className="space-y-10 text-gray-700 leading-relaxed">
        ...
        <AxisText
          title="独自の強みで自身の成長と社会への還元が可能な企業"
          text="AIが台等していく時代においても、AIをうまく扱う、またはAIでは代替できない独自の強みを持つことが重要だと考えています。"
          text2="そうした環境に身を置くことで、今後求められるエンジニアとしてのスキルを高め、意味のある価値を社会に提供していきたいと考えています。"
        />
      </section>
    </main>
  )
